	...
	while(getLine(*INPUT))
	  {
	    ...
	    #Split the long line after every paraenthasis and comma so we can
	    #process each node of the tree individually
	    foreach(split(/(?<=[\(\),])/,$line))
	      {
		if(/\(/)
		  {
...
* WHAT IS THIS: This script will convert a newick or dendogram format tree
                file, as is created by various clustering programs like
                clustalw, to tree format (used by Robert Leach's tree.pm perl
                module).  This format is like an indented outline.  Note, any
                distance metrics in the newick file will not be in the
                resultant tree file.

* INPUT FORMAT: Newick or dendogram format.  E.g.

"((((TCGA-E2-A1B1-01A-21R-A12P-07:2.50266852859575,(TCGA-E2-A1B6-01A-31R-A12P-07:8.47331351256288,(TCGA-E2-A14Z-01A-11R-A115-07:8.74251975943232,(TCGA-E2-A
108-01A-13R-A10J-07:46.3357681710517,TCGA-E2-A15M-01A-11R-A12D-07:46.3357681710517):8.74251975943232):8.47331351256288):2.50266852859575):0,(((TCGA-E2-A1BC
-01A-11R-A12P-07:1.31130105565107,(TCGA-E2-A15D-01A-11R-A115-07:6.42219813625317,...

* OUTPUT FORMAT: Tree format.  Used by Robert Leach's tree.pm perl
                 module.  This format is like an indented outline.  Note, any
                 distance metrics in the newick file will not be in the
                 resultant tree file.  E.g.
 ...
 2
  3
   4
    5
     6
      TCGA-E2-A1BD-10A-01D-A12N-01
      7
       TCGA-E2-A1L7-10A-01D-A141-01
       8
        TCGA-E2-A1LL-11A-21D-A141-01
        TCGA-E2-A150-10A-01D-A12A-01
     9
      10
       TCGA-E2-A1BC-10A-01D-A12N-01
       TCGA-E2-A1BC-01A-11D-A12N-01
      11
...
